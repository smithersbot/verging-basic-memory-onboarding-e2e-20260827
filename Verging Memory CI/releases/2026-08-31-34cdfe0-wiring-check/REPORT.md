...
- **Reports come back.** This page reached you through the same route every regression report uses (GET /v1/releases/run_20260831_bda2db6fc0c8/report), and your integration commits it the same way.
