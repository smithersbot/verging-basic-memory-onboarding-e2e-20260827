...
- **Reports come back.** This page reached you through the same route every regression report uses (GET /v1/releases/run_20260828_fd2217796a42/report), and your integration commits it the same way.
